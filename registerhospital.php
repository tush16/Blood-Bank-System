...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (($password == $cpassword)) {
        ...
        $sql = "INSERT INTO `users` (`name`, `blood`, `location`, `username`, `password`, `user_type`) VALUES ('$name', NULL, '$location', '$username', '$hash','$usertype');";
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Register as Hospital</p>

                                    <form class="mx-1 mx-md-4" action="registerhospital.php" method="POST">
